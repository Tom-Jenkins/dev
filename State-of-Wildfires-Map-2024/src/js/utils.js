...
export const popupContent = function(properties) {
    ...
    <h6 class="text-start">2023-24 fire season anomalies from the average fire season and rankings amongst all fire seasons.</h6>
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
          <td class="text-start">95th Percentile Fire Size Anomaly</td>
          <td class="text-end">${
        ...
        <tr>
          <td class="text-start">95th Percentile Rate of Growth Anomaly</td>
          <td class="text-end">${
